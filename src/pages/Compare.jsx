  ...
  const courses = [
    {
      ...
      description: "Embark on a transformative learning experience with our expert-level online course...",
      similarCourses: [
    ...
    <>
      ...
      <main>
        ...
        <div className="comparisons">
          ...
          {courses.map((course) => (
            <section key={course.id} className={`course ${course.id === 1 ? 'x' : 'y'}`}>
              <h2>{course.title}</h2>
              
              <div className="top">
                <div className="imageWrapper">
                  <img src="rescources/Image-not-found.png" className="imgNotFound" alt={course.title} />
                </div>
                <div className="textAndButtons">
                  ...
                  <div className="buttonContainer">
                    <button id="Remove" onClick={() => handleRemove(course.id)}>Remove</button>
                    <button id="Add" onClick={() => handleAddToCart(course.id)}>Add to cart</button>
                  </div>
                </div>
              </div>
                ...
                <div className="carouselHolder">
                  {course.similarCourses.map((similar, index) => (
                    <section key={index} className="carouselCard">
                      <a href="/">
                        <img src="rescources/Image-not-found.png" alt={similar.title} />
